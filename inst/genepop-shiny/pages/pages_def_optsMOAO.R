tabOptMOAO1 = fluidRow(align="left",
                    box(
                      title="Help",
                      tags$iframe(style="height:600px; width:100%",frameborder="0",scrolling="no", src="https://kimura.univ-montp2.fr/~rousset/Genepop.pdf#subsubsection.4.1.3"),
                      width = 12,
                      solidHeader = FALSE,
                      status = "warning",
...
tabOptMOAO2 = fluidRow(align="left",
                    box(
                      title="Help",
                      tags$iframe(style="height:600px; width:100%",frameborder="0",scrolling="no", src="https://kimura.univ-montp2.fr/%7Erousset/Genepop.pdf#subsubsection.4.1.3"),
                      width = 12,
                      solidHeader = FALSE,
                      status = "warning",
                      style='height:250px; overflow-y: scroll',
