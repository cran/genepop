...
\hypersetup{unicode=true,
            pdftitle={Genepop version 4.7.0},
            pdfauthor={F. Rousset},
            pdfborder={0 0 0},
            breaklinks=true}
...
recent compiler must be used,as described below. Second, test results of
previous versions cannot be exactly replicated.
...
computation of the regression. The bootstrap analyses ere already
handling correctly this case.

\textbf{Version 4.5}

A new keyword \texttt{inter\_all\_pairs} for setting
...
\(F_\mathrm{IS}\) is low, assuming that devaitions from Hardy-Weinberg
