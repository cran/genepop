...
author: "F. Rousset"
date: '`r genepop:::.getDateForGitbook()`'
output:
...
A new keyword `inter_all_pairs` for setting "popTypeSelection" allows one to perform spatial regressions (but not Mantel tests) between all pairs of individuals or populations belonging to different types (e.g., individuals belonging to different patches, excluding pairwise statistics for pairs of individuals within patches).
...
```{r child = '../extdoc/opt11-13.md'}
```

```{r child = '../extdoc/opt14-15.md'}
```
...
```{r child = '../extdoc/opt21.md'}
```

```{r child = '../extdoc/opt22.md'}
```
...
```{r child = '../extdoc/opt31-32.md'}
```

```{r child = '../extdoc/opt33-34.md'}
```
...
```{r child = '../extdoc/opt51.md'}
```

```{r child = '../extdoc/opt52.md'}
```

```{r child = '../extdoc/opt53.md'}
```
...
```{r child = '../extdoc/opt61-64.md'}
```

```{r child = '../extdoc/opt65.md'}
```

```{r child = '../extdoc/opt66.md'}
```
...
```{r child = '../extdoc/opt71.md'}
```

```{r child = '../extdoc/opt72-73.md'}
```

```{r child = '../extdoc/opt74.md'}
```
...
```{r child = '../extdoc/opt81.md'}
```

```{r child = '../extdoc/opt82.md'}
```

```{r child = '../extdoc/opt83.md'}
```

```{r child = '../extdoc/opt84-85.md'}
```

```{r child = '../extdoc/opt86.md'}
```
