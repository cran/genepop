...
testthat::expect_equal(readLines(outfile)[157],"Tertre Rotebo & last pop      14.523536  12    0.268532")
testthat::expect_equal(readLines(outfile)[158],"Bonneau 05    & last pop      48.079120  12    3.03e-006") # check use of scientific format.
#
...
testthat::expect_equal(readLines(outfile)[146],"Bonneau 05    & last pop      32.503644  10    0.000330")
